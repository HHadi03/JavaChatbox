...
To run the client:
Navigate to the directory where the project is located in command prompt and locate the src folder (ensure you have compiled client.java first), run the command "java Cerver"
